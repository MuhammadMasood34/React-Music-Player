      ...
      <div className='flex w-full shrink-0 items-center justify-between gap-2 overflow-x-auto bg-blue-100 px-2 py-2 md:h-full md:w-[100px] md:flex-col md:overflow-visible md:bg-transparent md:px-0 md:py-0 md:pb-[140px]'>
        ...
        {isDemoMode && (
          <button
            ...
            className="shrink-0"
          >
            <div className="flex h-14 w-14 flex-col items-center justify-center rounded-lg bg-[#1DB954]/20 text-[#1DB954] hover:bg-[#1DB954]/30 hover:text-[#1ed760] sm:w-20 md:mx-[20px] md:my-auto md:h-[80px] md:w-[80px] md:rounded-xl transition-colors cursor-pointer">
              <FaSpotify size="22px" />
